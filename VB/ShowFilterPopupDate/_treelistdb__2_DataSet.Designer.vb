...
Namespace ShowFilterPopupDate
	...
	'''</summary>
	<Global.System.Serializable(), Global.System.ComponentModel.DesignerCategoryAttribute("code"), Global.System.ComponentModel.ToolboxItem(True), Global.System.Xml.Serialization.XmlSchemaProviderAttribute("GetTypedDataSetSchema"), Global.System.Xml.Serialization.XmlRootAttribute("_treelistdb__2_DataSet"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")> _
	Partial Public Class _treelistdb__2_DataSet
		...
		Public Overrides Function Clone() As Global.System.Data.DataSet
			Dim cln As _treelistdb__2_DataSet = (CType(MyBase.Clone(), _treelistdb__2_DataSet))
			cln.InitVars()
		...
		Private Sub InitClass()
			Me.DataSetName = "_treelistdb__2_DataSet"
			Me.Prefix = ""
			Me.Namespace = "http://tempuri.org/_treelistdb__2_DataSet.xsd"
		...
		Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
			Dim ds As New _treelistdb__2_DataSet()
		...
		Partial Public Class Table1DataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddTable1Row(ByVal ID As Integer, ByVal ParentID As Integer, ByVal Name As String, ByVal Department As String, ByVal Hired As System.DateTime, ByVal Position As String) As Table1Row
				Dim rowTable1Row As Table1Row = (CType(Me.NewRow(), Table1Row))
				Dim columnValuesArray() As Object = { ID, ParentID, Name, Department, Hired, Position}
			...
			Private Sub InitClass()
				...
				Me.columnHired = New Global.System.Data.DataColumn("Hired", GetType(Global.System.DateTime), Nothing, Global.System.Data.MappingType.Element)
		...
		Partial Public Class Table1Row
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Property Hired() As System.DateTime
				Get
					Try
						Return (CDate(Me(Me.tableTable1.HiredColumn)))
					Catch e As Global.System.InvalidCastException
						Throw New Global.System.Data.StrongTypingException("The value for column 'Hired' in table 'Table1' is DBNull.", e)
					End Try
				End Get
				Set(ByVal value As System.DateTime)
					Me(Me.tableTable1.HiredColumn) = value
				End Set
			End Property
			...
			Public Function IsHiredNull() As Boolean
				Return Me.IsNull(Me.tableTable1.HiredColumn)
			End Function

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Sub SetHiredNull()
				Me(Me.tableTable1.HiredColumn) = Global.System.Convert.DBNull
			End Sub
	...
	End Class
End Namespace
Namespace ShowFilterPopupDate._treelistdb__2_DataSetTableAdapters
	...
	Partial Public Class Table1TableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `ParentID` IS NULL) OR (`ParentID` = ?)) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Department` IS NULL) OR (`Department` = ?)) AND ((? = 1 AND `Hired` IS NULL) OR (`Hired` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`Position` = ?)))"
			...
			Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_Hired", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Hired", Global.System.Data.DataRowVersion.Original, True, Nothing))
			Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Hired", Global.System.Data.OleDb.OleDbType.Date, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Hired", Global.System.Data.DataRowVersion.Original, False, Nothing))
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`ID`, `ParentID`, `Name`, `Department`, `Hired`, `Position`" & ") VALUES (?, ?, ?, ?, ?, ?)"
			...
			Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Hired", Global.System.Data.OleDb.OleDbType.Date, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Hired", Global.System.Data.DataRowVersion.Current, False, Nothing))
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `ID` = ?, `ParentID` = ?, `Name` = ?, `Department` = ?, `Hired` = ?, `Position` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `ParentID` IS NULL) OR (`ParentID` = ?)) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Department` IS NULL) OR (`Department` = ?)) AND ((? = 1 AND `Hired` IS NULL) OR (`Hired` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`Position` = ?)))"
			...
			Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Hired", Global.System.Data.OleDb.OleDbType.Date, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Hired", Global.System.Data.DataRowVersion.Current, False, Nothing))
			...
			Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_Hired", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Hired", Global.System.Data.DataRowVersion.Original, True, Nothing))
			Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_Hired", Global.System.Data.OleDb.OleDbType.Date, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "Hired", Global.System.Data.DataRowVersion.Original, False, Nothing))
		...
		Private Sub InitConnection()
			...
			Me._connection.ConnectionString = My.Settings.Default.treelistdb_ConnectionString
		End Sub
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ID, ParentID, Name, Department, Hired, [Position] FROM Table1"
		...
		Public Overridable Function Fill(ByVal dataTable As _treelistdb__2_DataSet.Table1DataTable) As Integer
		...
		Public Overridable Function GetData() As _treelistdb__2_DataSet.Table1DataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New _treelistdb__2_DataSet.Table1DataTable()
		...
		Public Overridable Function Update(ByVal dataTable As _treelistdb__2_DataSet.Table1DataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function

		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
		Public Overridable Function Update(ByVal dataSet As _treelistdb__2_DataSet) As Integer
		...
		Public Overridable Function Delete(ByVal Original_ID? As Integer, ByVal Original_ParentID? As Integer, ByVal Original_Name As String, ByVal Original_Department As String, ByVal Original_Hired? As Global.System.DateTime, ByVal Original_Position As String) As Integer
			...
			End If
			If (Original_Hired.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(7).Value = (CObj(0))
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CDate(Original_Hired.Value))
			Else
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(10).Value = (CStr(Original_Position))
			End If
		...
		Public Overridable Function Insert(ByVal ID? As Integer, ByVal ParentID? As Integer, ByVal Name As String, ByVal Department As String, ByVal Hired? As Global.System.DateTime, ByVal Position As String) As Integer
			...
			End If
			If (Hired.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(4).Value = (CDate(Hired.Value))
			Else
			...
			Else
				Me.Adapter.InsertCommand.Parameters(5).Value = (CStr(Position))
			End If
		...
		Public Overridable Function Update(ByVal ID? As Integer, ByVal ParentID? As Integer, ByVal Name As String, ByVal Department As String, ByVal Hired? As Global.System.DateTime, ByVal Position As String, ByVal Original_ID? As Integer, ByVal Original_ParentID? As Integer, ByVal Original_Name As String, ByVal Original_Department As String, ByVal Original_Hired? As Global.System.DateTime, ByVal Original_Position As String) As Integer
			If (ID.HasValue = True) Then
			...
			End If
			If (Hired.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CDate(Hired.Value))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(5).Value = (CStr(Position))
			End If
			If (Original_ID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CInt(Fix(Original_ID.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(6).Value = Global.System.DBNull.Value
			End If
			If (Original_ParentID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(7).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(8).Value = (CInt(Fix(Original_ParentID.Value)))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CStr(Original_Department))
			End If
			If (Original_Hired.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(13).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(14).Value = (CDate(Original_Hired.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(16).Value = (CStr(Original_Position))
			End If
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
		Public Overridable Function Update(ByVal ParentID? As Integer, ByVal Name As String, ByVal Department As String, ByVal Hired? As Global.System.DateTime, ByVal Position As String, ByVal Original_ID? As Integer, ByVal Original_ParentID? As Integer, ByVal Original_Name As String, ByVal Original_Department As String, ByVal Original_Hired? As Global.System.DateTime, ByVal Original_Position As String) As Integer
			Return Me.Update(Original_ID, ParentID, Name, Department, Hired, Position, Original_ID, Original_ParentID, Original_Name, Original_Department, Original_Hired, Original_Position)
		End Function
	End Class
	...
	Partial Public Class TableAdapterManager
		...
		'''</summary>
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
		Private Function UpdateUpdatedRows(ByVal dataSet As _treelistdb__2_DataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
		...
		'''</summary>
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
		Private Function UpdateInsertedRows(ByVal dataSet As _treelistdb__2_DataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
			Dim result As Integer = 0
			If (Me._table1TableAdapter IsNot Nothing) Then
		...
		'''</summary>
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
		Private Function UpdateDeletedRows(ByVal dataSet As _treelistdb__2_DataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
			Dim result As Integer = 0
			If (Me._table1TableAdapter IsNot Nothing) Then
		...
		'''</summary>
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
		Public Overridable Function UpdateAll(ByVal dataSet As _treelistdb__2_DataSet) As Integer
